...
public:
    ...
    DiskLoc insert(const DiskLoc& ext, int i) {
        ...
        if (e->lastRecord.isNull()) {
            ...
            ofs = e->lastRecord.getOfs() + em.recordForV1(e->lastRecord,0)->lengthWithHeaders();
        }
        DiskLoc dl(ext.a(), ofs);
        MmapV1RecordHeader* r = em.recordForV1(dl,0);
        ...
        if (e->firstRecord.isNull())
            ...
            txn.recoveryUnit()->writingInt(em.recordForV1(e->lastRecord,0)->nextOfs()) = ofs;
        e->lastRecord = dl;
        return dl;
    }
