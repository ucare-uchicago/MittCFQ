...
public:
    MmapV1RecordHeader(int lengthWithHeaders, int extentOfs, int nextOfs, int prevOfs) : _lengthWithHeaders(lengthWithHeaders), _extentOfs(extentOfs), _nextOfs(nextOfs), _prevOfs(prevOfs){}
