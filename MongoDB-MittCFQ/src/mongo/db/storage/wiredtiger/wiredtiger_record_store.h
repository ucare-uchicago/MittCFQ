...
public:
    ...
    virtual RecordData dataFor(OperationContext* txn, const RecordId& id,int fromDisk) const;

    virtual bool findRecord(OperationContext* txn, const RecordId& id, RecordData* out, int fromDisk) const;
